...
export interface OfferBody {pricingSnapshot?:string;logisticsQuoteId?:string;customerId:string;customer:string;contactId:string;contact:string;currency:string;quoteFx:string;quoteFxConfirmed:boolean;delivery:string;loadingPort:string;destinationPort:string;incoterm:string;payment:string;validUntil:string;remark:string;lines:OfferLine[];transports:Transport[];total:string;logisticsAllocations:LogisticsAllocation[]}
