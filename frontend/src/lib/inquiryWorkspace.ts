...
export interface FreightRate {productId:string;price:string;currency:string;unit:string;remark:string;usdPrice?:string;total?:string;usdTotal?:string}
...
export const blankQuote=():QuoteBody=>({company:'',currency:'USD',quoteCategory:'',delivery:'',validUntil:'',paymentTerms:'',incoterm:'',remark:'',prices:[],carrier:'',route:'',vessel:'',voyage:'',departure:'',arrival:'',transitDays:'',loadingPort:'',destinationPort:'',cargoIds:[],freightRates:[],charges:[],exchangeRates:{},totals:{},totalUsd:'',freightTotalUsd:'',otherChargesTotalUsd:'',attachments:[]})
