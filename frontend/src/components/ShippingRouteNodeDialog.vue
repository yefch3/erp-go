<template>
  <el-dialog v-model="open" :title="t('shipping.addRouteNode')" width="580px" destroy-on-close>
    <el-form ref="formRef" :model="form" :rules="rules" label-width="110px">
      ...
      <el-form-item :label="t('shipping.port')" prop="portId"><el-select v-model="form.portId" filterable style="width:100%" @change="applyPort"><el-option v-for="port in ports" :key="port.id" :value="port.id" :label="portOptionLabel(port)" /></el-select></el-form-item>
