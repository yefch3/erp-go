...
const props=defineProps<{supplierId:string|number;factoryId:string|number}>();const emit=defineEmits<{ 'update:supplierId':[string|number];'update:factoryId':[string|number];supplierSelected:[SupplierOption|undefined];factorySelected:[FactoryOption|undefined]}>()
