<template>
  <el-dialog v-model="open" title="更新船期进度" width="620px" destroy-on-close>
    ...
    <el-form ref="formRef" :model="form" :rules="rules" label-width="110px">
      ...
      <el-form-item v-if="['ARRIVE','DEPART'].includes(form.action)" :label="form.action==='ARRIVE'?'实际到港时间':'实际离港时间'"><el-date-picker v-model="form.actualTime" type="datetime" value-format="YYYY-MM-DDTHH:mm:ssZ" placeholder="留空则使用当前时间" style="width:100%" /></el-form-item>
