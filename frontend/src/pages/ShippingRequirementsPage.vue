  ...
  <div class="shipping-requirements-page">
    ...
    <el-dialog v-model="detailOpen" fullscreen :title="`${mode === 'inquiry' ? t('shipping.executionInquiryTitle') : t('shipping.ordersTitle')} · ${detail?.contractNo || ''}`" destroy-on-close class="shipping-fullscreen-detail">
      ...
      <template v-if="detail">
        ...
        <section v-if="detail.sourceSalesRemark?.trim()" class="source-sales-remark"><strong>{{ t('inquiryWorkspace.detail.salesRemark') }}</strong><p>{{ detail.sourceSalesRemark }}</p></section>
...
.source-sales-remark{margin-bottom:14px;padding:13px 16px;border:1px solid #cfe3ea;border-radius:10px;background:#f4fafc;color:#17485d}.source-sales-remark p{margin:6px 0 0;white-space:pre-wrap;overflow-wrap:anywhere;color:#334e5c}
</style>
