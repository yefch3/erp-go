# Frontend layout preference

- Check data-heavy pages at a 1366 × 768 CSS-pixel viewport, including the ERP sidebar. This represents the user's 14-inch laptop target.
- Size table columns from their header and actual values. Keep short numbers, units, dates, and statuses compact; give product descriptions, specifications, and remarks more room.
