...
const (
	...
	// MailExcelJobChanged: an asynchronous mail-to-Excel extraction reached a
	// terminal state. The addressed browser re-reads the owner-scoped job.
	MailExcelJobChanged = "mail.excel_job.changed"
