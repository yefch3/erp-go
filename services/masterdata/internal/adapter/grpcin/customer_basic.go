...
func customerBasicResponse(b app.CustomerImportRow, tenantID int64) *mdv1.GetCustomerBasicResponse {
	return &mdv1.GetCustomerBasicResponse{TenantId: tenantID, Basic: &mdv1.CustomerImportRow{
...
func (h *Handler) GetCustomerBasic(ctx context.Context, r *mdv1.GetCustomerBasicRequest) (*mdv1.GetCustomerBasicResponse, error) {
	b, err := h.svc.GetCustomerBasic(ctx, grpcx.TenantID(ctx), r.CustomerId)
	return customerBasicResponse(b, grpcx.TenantID(ctx)), err
}
func (h *Handler) SaveCustomerBasic(ctx context.Context, r *mdv1.SaveCustomerBasicRequest) (*mdv1.SaveCustomerBasicResponse, error) {
	...
	result := customerBasicResponse(b, grpcx.TenantID(ctx))
	return &mdv1.SaveCustomerBasicResponse{Basic: result.Basic, TenantId: result.TenantId}, err
}
