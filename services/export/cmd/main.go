...
func run(log *slog.Logger) error {
	...
	console.Add(cfg.ConsumerGroup, dlDecision, kafkax.ReplayHandler(decisionHandler, idempotency.New(pool, cfg.ConsumerGroup)))
	console.Add(cfg.StockConsumerGroup, dlStock, kafkax.ReplayHandler(stockHandler, idempotency.New(pool, cfg.StockConsumerGroup)))
