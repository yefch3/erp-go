...
func (h *ContractHandler) UseDeadLetterConsole(c *deadletter.Console) { h.dead = c }

func (h *ContractHandler) ListFailedEvents(ctx context.Context, _ *exv1.ListFailedEventsRequest) (*exv1.ListFailedEventsResponse, error) {
	if h.dead == nil {
	...
	return &exv1.ListFailedEventsResponse{Events: out}, nil
}

func (h *ContractHandler) ReplayFailedEvent(ctx context.Context, req *exv1.ReplayFailedEventRequest) (*exv1.ReplayFailedEventResponse, error) {
	if h.dead == nil {
		return nil, apierr.Internal("DL_NOT_WIRED", "死信面未接线")
	}
	...
	return &exv1.ReplayFailedEventResponse{}, nil
}
