...
func (h *Handler) UseDeadLetterConsole(c *deadletter.Console) { h.dead = c }

func (h *Handler) ListFailedEvents(ctx context.Context, _ *ivv1.ListFailedEventsRequest) (*ivv1.ListFailedEventsResponse, error) {
	if h.dead == nil {
	...
	return &ivv1.ListFailedEventsResponse{Events: out}, nil
}

func (h *Handler) ReplayFailedEvent(ctx context.Context, req *ivv1.ReplayFailedEventRequest) (*ivv1.ReplayFailedEventResponse, error) {
	if h.dead == nil {
		return nil, apierr.Internal("DL_NOT_WIRED", "死信面未接线")
	}
	...
	return &ivv1.ReplayFailedEventResponse{}, nil
}
