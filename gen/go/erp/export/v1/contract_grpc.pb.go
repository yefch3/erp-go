...
func (c *contractServiceClient) CheckContractExecution(ctx context.Context, in *CheckContractExecutionRequest, opts ...grpc.CallOption) (*CheckContractExecutionResponse, error) {
	...
	out := new(CheckContractExecutionResponse)
	err := c.cc.Invoke(ctx, ContractService_CheckContractExecution_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contractServiceClient) ContractWorkflow(ctx context.Context, in *ContractWorkflowRequest, opts ...grpc.CallOption) (*ContractWorkflowResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ContractWorkflowResponse)
	err := c.cc.Invoke(ctx, ContractService_ContractWorkflow_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedContractServiceServer) ContractWorkflow(context.Context, *ContractWorkflowRequest) (*ContractWorkflowResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ContractWorkflow not implemented")
}
...
func _ContractService_CheckContractExecution_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckContractExecutionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ContractServiceServer).CheckContractExecution(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ContractService_CheckContractExecution_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContractServiceServer).CheckContractExecution(ctx, req.(*CheckContractExecutionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ContractService_ContractWorkflow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ContractWorkflowRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ContractServiceServer).ContractWorkflow(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ContractService_ContractWorkflow_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContractServiceServer).ContractWorkflow(ctx, req.(*ContractWorkflowRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ContractService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ContractWorkflow",
			Handler:    _ContractService_ContractWorkflow_Handler,
		},
		{
